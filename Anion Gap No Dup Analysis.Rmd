...
### Linear Regression
```{r, echo = FALSE}
summary(lm(RESULT ~ TAT_hrs, data = filter(df.2022.rmdup.wkday.tat.otpt, TAT_hrs <= 1 & RESULT < 30)))
ggplot(data = df.2022.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  geom_point() +
  xlim(c(0,1)) +
  ylim(c(0,30)) +
  geom_smooth(method = lm) +
  labs(title = "2022 Turnaround Time vs Anion Gap Result (Outpatient, Normal Cr, excl. data not shown)")

summary(lm(RESULT ~ TAT_hrs, data = filter(df.2022.rmdup.wkday.tat.otpt, TAT_hrs <= 2 & RESULT < 40)))
ggplot(data = df.2022.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  geom_point() +
  xlim(c(0,2)) +
  ylim(c(0,40)) +
...
summary(lm(RESULT ~ TAT_hrs, data = filter(df.2022.rmdup.wkday.tat.otpt, TAT_hrs <= 3 & RESULT < 40)))
ggplot(data = df.2022.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  geom_point() +
  xlim(c(0,3)) +
  ylim(c(0,40)) +
...
summary(lm(RESULT ~ TAT_hrs, data = filter(df.2022.rmdup.wkday.tat.otpt, TAT_hrs <= 4 & RESULT < 40)))
ggplot(data = df.2022.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  geom_point() +
  xlim(c(0,4)) +
  ylim(c(0,40)) +
...
summary(lm(RESULT ~ TAT_hrs, data = filter(df.2023.rmdup.wkday.tat.otpt, TAT_hrs <= 1 & RESULT < 30)))
ggplot(data = df.2023.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  geom_point() +
  xlim(c(0,1)) +
  ylim(c(0,30)) +
  geom_smooth(method = lm) +
  labs(title = "2023 Turnaround Time vs Anion Gap Result (Outpatient, Normal Cr, excl. data not shown)")

summary(lm(RESULT ~ TAT_hrs, data = filter(df.2023.rmdup.wkday.tat.otpt, TAT_hrs <= 2 & RESULT < 30)))
ggplot(data = df.2023.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  geom_point() +
  xlim(c(0,2)) +
  ylim(c(0,30)) +
...
ggplot(data = df.2023.rmdup.wkday.tat.otpt, aes(x = TAT_hrs, y = RESULT)) +
  ...
  ylim(c(0,30)) +
  geom_smooth(method = lm) +
  labs(title = "2023 Turnaround Time vs Anion Gap Result (Outpatient, Nl Cr, excl. data not shown)")

df.2022.rmdup.wkday.tat.otpt <- df.2022.rmdup.wkday.tat.otpt %>%
  mutate(
    TAT_hist = cut(df.2022.rmdup.wkday.tat.otpt$TAT_hrs, breaks = seq(0, 2, 0.25))
  )
df.2023.rmdup.wkday.tat.otpt <- df.2023.rmdup.wkday.tat.otpt %>% 
  mutate(
    TAT_hist = cut(df.2023.rmdup.wkday.tat.otpt$TAT_hrs, breaks = seq(0, 2, 0.25))
  )

ggplot(data = df.2022.rmdup.wkday.tat.otpt, aes(x = TAT_hist, y = RESULT)) +
  geom_boxplot(
    data = filter(df.2022.rmdup.wkday.tat.otpt, TAT_hist != "NA"), 
  ...
  geom_boxplot(
    data = filter(df.2023.rmdup.wkday.tat.otpt, TAT_hist != "NA"), 
    position = position_nudge(x = 0.22), 
    width = 0.4,
    fill = "#003648",
    alpha = 0.5
  ...
  theme_minimal() +
  labs(title = "2022 and 2023 Anion Gap Result by Turnaround Time (Outpt, nl Cr)")
...
### Plotting AG result distributions by TAT

ggplot(df.2022.rmdup.wkday.tat, aes(x = RESULT)) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, TAT_hrs < 0.25), color = "red", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 0.25, 0.5)), color = "orange", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 0.5, 0.75)), color = "yellow", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 0.75, 1)), color = "green", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 1, 1.25)), color = "blue", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 1.25, 1.5)), color = "purple", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 1.5, 1.75)), color = "magenta", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 1.75, 2)), color = "pink", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 2, 2.25)), color = "red4", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 2.25, 2.5)), color = "orange4", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 2.5, 2.75)), color = "yellow4", binwidth = 1) +
  geom_freqpoly(data = filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 2.75, 3)), color = "green4", binwidth = 1) +
  theme_minimal() +
  labs(title = "2022 Anion Gap Result Distributions by 15-min Turnaround Time")

df.2022.rmdup.wkday.tat <- df.2022.rmdup.wkday.tat %>% 
  mutate(
    TAT_hist = cut(df.2022.rmdup.wkday.tat$TAT_hrs, breaks = seq(0, 3, 0.25))
  )

ggplot(data = df.2022.rmdup.wkday.tat, aes(x = TAT_hist, y = RESULT)) +
  geom_boxplot() +
  coord_cartesian(ylim = c(0, 40), xlim = c(0, 10)) +
  theme_minimal() +
  labs(title = "2022 Anion Gap Result Distributions by Turnaround Time (15-min intervals)")

# 
# t.test(
#   filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 0.75, 1))$RESULT, 
#   filter(df.2022.rmdup.wkday.tat, between(TAT_hrs, 1.75, 2))$RESULT
#   )
# 
# t.test(
#   filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 0.75, 1))$RESULT, 
#   filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 1.75, 2))$RESULT
#   )


ggplot(df.2022.rmdup.wkday.tat, aes(x = RESULT)) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, TAT_hrs < 0.25), color = "red", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 0.25, 0.5)), color = "orange", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 0.5, 0.75)), color = "yellow", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 0.75, 1)), color = "green", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 1, 1.25)), color = "blue", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 1.25, 1.5)), color = "purple", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 1.5, 1.75)), color = "magenta", binwidth = 1) +
  geom_freqpoly(data = filter(df.2023.rmdup.wkday.tat, between(TAT_hrs, 1.75, 2)), color = "pink", binwidth = 1) +
  theme_minimal() +
  labs(title = "2023 Anion Gap Result Distributions by 15-min Turnaround Time")

df.2023.rmdup.wkday.tat <- df.2023.rmdup.wkday.tat %>% 
  mutate(
    TAT_hist = cut(df.2023.rmdup.wkday.tat$TAT_hrs, breaks = seq(0, 3, 0.25))
  )

ggplot(data = df.2023.rmdup.wkday.tat, aes(x = TAT_hist, y = RESULT)) +
  geom_boxplot() +
  coord_cartesian(ylim = c(0, 40), xlim = c(0, 10)) +
  theme_minimal() + 
  labs(title = "2023 Anion Gap Result Distributions by Turnaround Time (15-min intervals)")
