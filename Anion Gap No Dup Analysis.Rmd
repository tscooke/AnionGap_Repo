...
highRateComparison <- function(dataframe1, dataframe2, highlevel) {
  df1.name <- deparse(substitute(dataframe1))
  df2.name <- deparse(substitute(dataframe2))
  ...
  # +
  #   annotate("text", x = 12, y = 0.2,label = paste0("Red = ",df1.name), color = "#c5373d") +
  #   annotate("text", x = 12, y = 0.19, label = paste0("Blue = ",df2.name), color = "#006eae")
