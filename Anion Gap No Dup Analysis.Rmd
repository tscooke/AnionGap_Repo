...
Inpt.plot <- highRateComparison(
  ...
  highlevel = high) +
  labs(title = paste0("Proportion of Anion Gap ≥ ", high," by Hour, Inpatient (weekdays)")) 

Emerg.plot <- highRateComparison(
  filter(df.2022.rmdup.wkday, Location == "Emergency"),
  filter(df.2023.rmdup.wkday, Location == "Emergency"),
  highlevel = high) +
  labs(title = paste0("Proportion of Anion Gap ≥ ", high," by Hour, Emergency (weekdays)")) 
...
Outpt.plot <- highRateComparison(
  ...
  highlevel = high) +
  labs(title = paste0("Proportion of Anion Gap ≥ ", high," by Hour, Outpatient (weekdays)")) 
...
HighTotal.plot <- ggplot() +
  ...
  scale_fill_gradient(low = "#cae5ee", high = "#003648") +
  labs(fill = "2023 Total") +
  labs(title = "Proportion of High Anion Gap by Time of Day (weekdays)") +
  theme_minimal()
HighTotal.plot
...
ggplot(df.2022.rmdup.wkday.tat, aes(x = TAT_hrs)) +
  ...
  annotate("text", x = 1, y = 6000, label = "2022", color = "red", alpha = 0.5, hjust = 0) +
  annotate("text", x = 0.75, y = 10500, label = "2023", color = "blue", alpha = 0.5, hjust = 0) +
