...
plot.2022 <- ggplot(df.2022.rmdup.wkday, aes(x = RESULT)) +
  geom_freqpoly(
    color = "blue",
    binwidth = 1) +
  labs(title = "Frequency Plot for 2022, 2023 (dups removed, weekdays)")
...
#     alpha = 0.5,
#     binwidth = 1) +
#   labs(title = "Frequency Plot for 2023 (dups removed, weekdays)")
...
# wkdayplot.2022 <- ggplot(df.2022.rmdup.wkday, aes(x = Time)) +
#   geom_bar()
# print(wkdayplot.2022)

timeplot.2022 <- ggplot(by_Time.2022, aes(y = Total)) +
  geom_bar() 

# +
#   geom_line(aes(x = Time, y = HighRate))
timeplot.2022
